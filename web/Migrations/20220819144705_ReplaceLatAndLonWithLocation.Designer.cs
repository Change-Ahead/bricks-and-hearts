...
namespace BricksAndHearts.Migrations
{
    ...
    [Migration("20220819144705_ReplaceLatAndLonWithLocation")]
    partial class ReplaceLatAndLonWithLocation
    {
            ...
            modelBuilder.Entity("BricksAndHearts.Database.PropertyDbModel", b =>
                {
                    ...
                    b.HasCheckConstraint("OccupiedUnits", "[OccupiedUnits] <= [TotalUnits]");
                });
            ...
            modelBuilder.Entity("BricksAndHearts.Database.UserDbModel", b =>
                {
                    ...
                    b.Property<string>("GoogleProfileImageUrl")
                        .HasColumnType("nvarchar(max)");
